...
namespace WindowsForms
{
    class ControlData
    {
        ...
        private void settingsText(Settings settings)
        {
            ...
            {
                settings.left.Columns[0].HeaderText = FormText.name[10];
                settings.left.RowCount = 11;
                settings.left.Rows[i++].Cells[0].Value = FormText.application[2];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[4];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[5];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[8];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[9];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[10];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[14];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[18];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[19];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[25];
                settings.left.Rows[i++].Cells[0].Value = FormText.application[23];
            }
            if (settings.typeForm == TypeForm.specification)
            {
                settings.left.Columns[0].HeaderText = FormText.name[11];
                settings.left.RowCount = 3;
                settings.left.Rows[i++].Cells[0].Value = FormText.specification[23];
                settings.left.Rows[i++].Cells[0].Value = FormText.specification[24];
                settings.left.Rows[i++].Cells[0].Value = FormText.specification[36];
            }
            if (settings.typeForm == TypeForm.engraving)
            {
                ...
                settings.left.Rows[i++].Cells[0].Value = FormText.engraving[25];
            }
        }
        ...
        public ControlData(Settings settings)
        {
            ...
            if (settings.typeForm == TypeForm.specification)
            {
                ...
                if (table == SqlSpecification.SpecificationParametersWorkpiece.ToString())
                {
                    ...
                    settings.right.Columns[1].HeaderText = (string)settings.left.CurrentRow.Cells[0].Value;
                    settings.right.Columns[2].HeaderText = FormText.specification[6];
                    settings.right.Columns[3].HeaderText = FormText.specification[7];
                    settings.right.Columns[8].HeaderText = FormText.specification[40];
                    settings.right.Columns[9].HeaderText = FormText.specification[41];
                }
                if (table == SqlSpecification.SpecificationPrametryMachining.ToString())
                {
                    ...
                    for (int i = 0; i < settings.right.Columns.Count; i++)
                        if (i != 1 && i != 3 && i != 8 && i != 10 && i != 14)
                            settings.right.Columns[i].Visible = false;
                    settings.right.Columns[1].HeaderText = (string)settings.left.CurrentRow.Cells[0].Value;
                    settings.right.Columns[3].HeaderText = String.Format("{0} {1}",  FormText.specification[28], FormText.specification[25]);
                    settings.right.Columns[8].HeaderText = String.Format("{0} {1}", FormText.specification[35], FormText.specification[26]);
                    settings.right.Columns[10].HeaderText = FormText.specification[25];
                    settings.right.Columns[14].HeaderText = FormText.specification[26];
                }
                if (table == SqlSpecification.SpecificationRotationalSpeed.ToString())
                {
                    settings.right.DataSource = sqlQuery.GetArrayList(table);
                    settings.right.Columns[0].Visible = false;
                    settings.right.Columns[1].HeaderText = FormText.specification[37];
                    settings.right.Columns[2].HeaderText = FormText.specification[38];
                    settings.right.Columns[3].HeaderText = FormText.specification[39];
                }
            }
            if (settings.typeForm == TypeForm.engraving)
            {
